...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from matfunc.y  */
...
const int YY_parse_CLASS::LB=258;
const int YY_parse_CLASS::RB=259;
const int YY_parse_CLASS::MAT=260;
const int YY_parse_CLASS::ADD=261;
const int YY_parse_CLASS::MINUS=262;
const int YY_parse_CLASS::DIV=263;
const int YY_parse_CLASS::NEG=264;
const int YY_parse_CLASS::REV=265;
...
static const short yyprhs[] = {     0,
     0,     3,     5,     7,    10,    12,    16,    20,    22,    26,
    30,    32,    35,    38,    40,    42,    46,    50,    52,    55,
    59,    63
};

static const short yyrhs[] = {    23,
    24,     0,    24,     0,    13,     0,    25,    13,     0,    26,
     0,    26,    14,    27,     0,    26,    15,    27,     0,    27,
     0,    27,    16,    28,     0,    27,    17,    28,     0,    28,
     0,    10,    28,     0,     9,    28,     0,    29,     0,    30,
     0,    18,    26,    19,     0,    20,    31,    21,     0,    32,
     0,    32,    22,     0,    20,    33,    21,     0,    12,    22,
    33,     0,    12,     0
};
...
static const short yyrline[] = { 0,
    41,    42,    45,    46,    51,    53,    54,    55,    57,    58,
    59,    61,    62,    63,    65,    66,    68,    70,    71,    72,
    74,    75
};

static const char * const yytname[] = {   "$","error","$illegal.","LB","RB",
"MAT","ADD","MINUS","DIV","NEG","REV","DOT","NUM","'\\n'","'+'","'-'","'*'",
"'/'","'('","')'","'['","']'","','","input","line","expr","s1","s2","s3","s4",
"MATRIX","COLS","ROW","VEC",""
};
#endif
...
static const short yydefact[] = {     0,
     0,     0,     3,     0,     0,     0,     2,     0,     5,     8,
    11,    14,    15,    13,    12,     0,     0,     0,    18,     1,
     4,     0,     0,     0,     0,    16,    22,     0,    17,    19,
     6,     7,     9,    10,     0,    20,    21,     0,     0
};

static const short yydefgoto[] = {     6,
     7,     8,     9,    10,    11,    12,    13,    18,    19,    28
};

static const short yypact[] = {    -4,
     8,     8,-32768,     8,   -13,     2,-32768,    -3,    15,    16,
-32768,-32768,-32768,-32768,-32768,   -11,     1,    -2,     3,-32768,
-32768,     8,     8,     8,     8,-32768,     5,     0,-32768,-32768,
    16,    16,-32768,-32768,     1,-32768,-32768,    31,-32768
};

static const short yypgoto[] = {-32768,
    30,-32768,    33,    12,    -1,-32768,-32768,-32768,-32768,     4
};
...
static const short yytable[] = {    14,
    15,    38,    22,    23,     1,     2,    17,    26,     3,    21,
     1,     2,    27,     4,     3,     5,     1,     2,    29,     4,
    36,     5,    33,    34,    30,     4,    35,     5,    22,    23,
    39,    24,    25,    31,    32,    20,    16,     0,    37
};

static const short yycheck[] = {     1,
     2,     0,    14,    15,     9,    10,    20,    19,    13,    13,
     9,    10,    12,    18,    13,    20,     9,    10,    21,    18,
    21,    20,    24,    25,    22,    18,    22,    20,    14,    15,
     0,    16,    17,    22,    23,     6,     4,    -1,    35
};
